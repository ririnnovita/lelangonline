...
class Laporan extends CI_Controller
{
	...
	public function cetak_laporan_petugas() {
		//load library
		$this->load->model('Petugas_model');
		$this->load->library('pdf');

		// load model dashboard
		$data['laporan'] = $this->Petugas_model->filter_laporan();

		$this->pdf->setPaper('A4', 'potrait');
		$this->pdf->filename = "laporan-petugas.pdf";

		//run dompdf
		$this->pdf->load_view('admin/laporan/cetak_laporan_petugas', $data);
	}
	...
	public function cetak_laporan_masyarakat() {
		...
		// load model dashboard
		$data['laporan'] = $this->Masyarakat_model->filter_laporan();

		$this->pdf->setPaper('A4', 'potrait');
		$this->pdf->filename = "laporan-Masyarakat.pdf";

		//run dompdf
		$this->pdf->load_view('admin/laporan/cetak_laporan_masyarakat', $data);
	}
	...
	public function cetak_laporan_barang() {
		...
		//run dompdf
		$this->pdf->load_view('admin/laporan/cetak_laporan_barang', $data);
	}
	...
	public function cetak_laporan_pemenang() {
		...
		//run dompdf
		$this->pdf->load_view('admin/laporan/cetak_laporan_pemenang', $data);
	}
}
