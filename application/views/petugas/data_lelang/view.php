    <div class="container-fluid">
        ...
        <div class="card border-dark">
			...
			<strong>VIEW DATA LELANG</strong>
			 	...
			 	<div class="card-header bg-warning text-white">
						...
						<div class="card-body">
							...
							<?php else : ?>
									...
									<!-- <?= anchor('petugas/Data_lelang/finish/' . $auction->id_lelang, '<i class="text-warning fas fa-fw fa-chess-queen"></i>') ?> -->

									
									<a onclick="Finish('<?= base_url('petugas/Data_lelang/finish/') . $auction->id_lelang ?>')"><i class="text-warning fas fa-fw fa-chess-queen"></i></a>
