        ...
        <div class="card-body bg-light">
			...
			<form method="post" action="" class="form-user">
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label ">
						<strong class="text-primary">Laporan Data Masyarakat</strong>
					</label>
					<div>
					<a href="<?= base_url('admin/laporan/cetak_laporan_masyarakat'); ?>" class="btn btn-primary"><i class="fas fa-fw fa-print"></i> Cetak Data Masyarakat</a>
					</div>
                </div>
				<hr>
				<div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label ">
						<strong class="text-primary">Laporan Data Petugas</strong>
					</label>
					<div>
					<a href="<?= base_url('admin/laporan/cetak_laporan_petugas'); ?>" class="btn btn-primary" ><i class="fas fa-fw fa-print"></i> Cetak Data Petugas</a>
					</div>
                </div>
				<hr>
                <div class="form-group row">
					...
					<div>
					<a href="<?= base_url('admin/laporan/cetak_laporan_barang'); ?>" class="btn btn-primary" data-toggle="modal" data-target="#cetaklaporanbarang"><i class="fas fa-fw fa-print"></i> Cetak Data Barang</a>
				...
				<div class="form-group row">
					...
					<a href="<?= base_url('admin/laporan/cetak_laporan_pemenang'); ?>" class="btn btn-primary" data-toggle="modal" data-target="#cetaklaporanpemenang"><i class="fas fa-fw fa-print"></i> Cetak Data Pemenang</a>
					</div>
                </div>
				<hr>
                <div class="form-group row">
					...
					<a href="<?= base_url('admin/laporan/cetak_laporan_lelang'); ?>" class="btn btn-primary" data-toggle="modal" data-target="#cetaklaporanlelang"><i class="fas fa-fw fa-print"></i> Cetak Data Lelang</a>
					</div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="card-body">
			<form method="post" action="<?= base_url('admin/laporan/cetak_laporan_barang') ?>" class="form-user">
		...
		<!-- laporan pemenang -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="card-body">
			<form method="post" action="<?= base_url('admin/laporan/cetak_laporan_pemenang') ?>" class="form-user">
