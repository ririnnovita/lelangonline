        ...
        <div class="card border-dark">
			...
			<div class="from-group">
				...
				<div class="form-group">
					...
					<input type="text" name="nama_barang" id="nama_barang" value="<?= $tb_barang['nama_barang'] ?>" class="form-control" required placeholder="Enter the product name" />
				</div>
				<div class="form-group">
					<label for="desc"><strong>Deskripsi Barang</strong></label>
					<textarea name="deskripsi_barang" id="deskripsi_barang" rows="10" class="form-control" required><?= htmlspecialchars($tb_barang['deskripsi_barang']) ?></textarea>
				</div>
				<div class="form-group">
					<label for="price"><strong>Harga Awal</strong></label>
					<input type="number" name="harga_awal" id="harga_awal" value="<?= $tb_barang['harga_awal'] ?>" class="form-control" required placeholder="Enter the product price" />
				</div>
				<div class="form-group">
					<label for="tgl"><strong>Tanggal Barang</strong></label>
					<br>
					<input type="date" name="tgl" id="tgl" value="<?= $tb_barang['tgl'] ?>" required />
				</div>
