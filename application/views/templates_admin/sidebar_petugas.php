<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Data Lelang -->
            <li class="nav-item ">
                <a class="nav-link" href="<?= base_url('petugas/Data_lelang/pemenang'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="na navbar-nav navbar-right">
                            <?php if ($this->session->userdata('username')) { ?>
                                <li>
                                    <div class="text-primary"><i class="fas fa-fw fa-user"></i><?= $this->session->userdata('nama_petugas') ?> | petugas</div>
                                </li>
                            <?php } ?>
